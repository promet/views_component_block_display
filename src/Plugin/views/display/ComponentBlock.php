...
class ComponentBlock extends DisplayPluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['views_component_block_display_category'] = ['default' => $this->t('Lists (Views)')];
  ...
  public function optionsSummary(&$categories, &$options) {
    ...
    $block_category = $this->getOption('views_component_block_display_category');
    ...
    $options['views_component_block_display_category'] = [
      'category' => 'views_component_block_display',
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    switch ($form_state->get('section')) {
      ...
      case 'views_component_block_display_category':
        $form['#title'] .= $this->t('Block category');
        $form['views_component_block_display_category'] = [
          '#type' => 'textfield',
          ...
          '#default_value' => $this->getOption('views_component_block_display_category'),
        ];
        break;
